...
const instructions: { [key: string]: string } = {
  "Cuidados com seu gatinho":
    "Alimente-o com ração adequada, mantenha a caixa de areia limpa, e leve ao veterinário regularmente.",
  "Cuidados com seu doguinho":
    "Ofereça passeios diários, ração balanceada e muito carinho. Não esqueça de vacinar e desvermifugar.",
  "Cuidados com seu hamster":
    "Mantenha a gaiola limpa, ofereça uma dieta variada com sementes e frutas, e certifique-se de que ele tenha espaço para se exercitar.",
  "Cuidados com seu peixinho":
    "Troque a água regularmente, mantenha o aquário limpo e alimente com a quantidade certa para evitar sobrealimentação.",
  "Cuidados com seu pássaro":
    "Ofereça uma dieta rica em sementes, frutas e vegetais. Mantenha a gaiola limpa, proporcione espaço para o pássaro voar e, se possível, permita que ele tenha interação social e estimulação mental.",
};
...
export const Chat = () => {
  ...
  const renderMessage = ({ item }: { item: Message }) => (
    <View
      style={[
        styles.message,
        item.sender === "Usuario" ? styles.yourMessage : styles.otherMessage,
      ]}
    >
